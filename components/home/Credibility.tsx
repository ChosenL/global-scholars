        ...
        <FadeIn>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Our advice doesn’t come from theory alone. It comes from living the
              journey ourselves, overcoming the obstacles, and helping others
              avoid the same uncertainty.
            </p>
          </div>
        </FadeIn>
