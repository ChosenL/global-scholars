...
export default function OrganizationShell({
  ...
  return (
    <main className="min-h-screen bg-[#F4F7FA] text-[#071526]">
      <header className="border-b border-white/10 bg-[#071526] text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-5 md:px-8">
          <Link
            href="/organizations"
            className="flex items-center gap-3 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C8A24A]"
          >
      ...
      <div className="mx-auto max-w-7xl px-5 py-8 md:px-8 md:py-10">
        {backHref ? (
          <Link
            href={backHref}
            className="mb-5 inline-flex items-center gap-2 rounded-lg text-sm font-bold text-slate-600 hover:text-[#071526] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C8A24A]"
          >
